    ...
    <table id="example" class="display" cellspacing="0" width="100%">
        <thead>
         ...
         <tbody>
            ...
            <tr>
                <td><?php echo $this->datos[$i]['ID_CATEGORIA_EJERCICIO']//id ?></td>
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="...">
                        <a class="btn btn-success" href="<?php echo BASE_URL."cat_ejercicio/editar/".$this->datos[$i]['ID_CATEGORIA_EJERCICIO']?>">
                            <i class="fa fa-pencil fa-fw"></i> Editar
                        </a>
                        <a class="btn btn-danger" href="<?php echo BASE_URL."cat_ejercicio/eliminar/".$this->datos[$i]['ID_CATEGORIA_EJERCICIO']?>">
