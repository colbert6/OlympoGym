...
<fieldset>
    ...
    <form class="form-horizontal" role="form" id="form_perfil" method="post" action="<?php echo $this->action; ?>">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
            <input name="id_tipo_membresia" id="id_categoria_evento" class="form-control"  readonly="readonly"
      ...
      <div class="form-group">
        ...
        <div class="col-sm-offset-3 col-sm-9">
          ...
          <a style="margin-left: 8%" href="<?php echo BASE_URL?>tipo_membresia" type="submit" class="btn btn-danger">Cancelar</a>
        </div>
      </div>
