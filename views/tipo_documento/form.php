...
<fieldset>
    ...
    <form class="form-horizontal" role="form" id="form_perfil" method="post" action="<?php echo $this->action; ?>">
      ...
      <?php if(isset ($this->datos[0]['ID_TIPO_DOCUMENTO'])) {?>  
      <div class="form-group">
        <label class="control-label col-sm-3" >IDENTIFICADOR:</label>
        <div class="col-sm-9">
            <input name="id_tipo_documento" id="id_tipo_documento" class="form-control"  readonly="readonly"
                   value="<?php echo $this->datos[0]['ID_TIPO_DOCUMENTO'];?>">
        </div>
      </div>  
      <?php } ?>  
      <div class="form-group">
        ...
        <div class="col-sm-offset-3 col-sm-9">
          ...
          <a style="margin-left: 8%" href="<?php echo BASE_URL?>tipo_documento" type="submit" class="btn btn-danger">Cancelar</a>
        </div>
      </div>
