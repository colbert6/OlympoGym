...
class socioController extends controller{
    ...
    public function __construct() {
        ...
        $this->_ubigeo = $this->loadModel('ubigeo');
    ...
    public function vermas($id){
        ...
        $this->_view->titulo = 'Datos del Socio';
        $this->_view->action = BASE_URL . 'socio/vermas/'.$id;
    ...
    public function editar($id) {
        ...
        $this->_view->titulo = 'Actualizar Socio';
        $this->_view->action = BASE_URL . 'socio/editar/'.$id;
