    ...
    <table id="example" class="display" cellspacing="0" width="100%">
        <thead>
         ...
         <tbody>
            ...
            <tr>
                <td><?php echo $this->datos[$i]['ID_MARCA']//id ?></td>
                <td><?php echo $this->datos[$i]['DESCRIPCION']//nombre ?></td> 
                
                <td>
                    <div class="btn-group" role="group" aria-label="...">
                        <a class="btn btn-success" href="<?php echo BASE_URL."marca/editar/".$this->datos[$i]['ID_MARCA']?>">
                            <i class="fa fa-pencil fa-fw"></i> Editar
                        </a>
                        <a class="btn btn-danger" href="<?php echo BASE_URL."marca/eliminar/".$this->datos[$i]['ID_MARCA']?>">
