<?php
class cat_eventoController extends controller{
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->_model = $this->loadModel('cat_evento');
        
        $this->_modulos->url = 'cat_evento';
    ...
    public function index() {
        ...
        $this->_view->titulo = 'Lista de Eventos';
    ...
    public function nuevo() {
        if (@$_POST['guardar'] == 1) {
            ...
            $this->_model->inserta();
            $this->redireccionar('cat_evento');
        }
        $this->_view->titulo = 'Registrar Categoria de Evento';
        $this->_view->action = BASE_URL . 'cat_evento/nuevo';
    ...
    public function editar($id) {
        ...
        $this->_view->titulo = 'Actualizar Categoria de Evento';
        $this->_view->action = BASE_URL . 'cat_evento/editar/'.$id;
